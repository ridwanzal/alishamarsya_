                    ...
                    <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                        ...
                                        <?php echo form_open_multipart('uploads/multiple/banners_two/banner_two/banner_two'); ?>
                                            <h5 class="card-header">Upload Image ( Recommended Width : 1110px )</h5>
                                            <div class="card-body">
                                                    <div class="row">
                                                            ...
                                                            <?php
                                                                function check_empty($value){
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><img style="height:50px;border-radius:4px;" src="<?php echo base_url()?>/assets/banners_two/<?php echo $list->image_name;?>"></td>
