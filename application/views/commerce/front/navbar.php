...
<section class="nav_container">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar_custom">
          <!-- <a href="<?php echo base_url();?>"><span id="" style="font-weight:bold;color:#fff;margin-right:50px;font-size:20px;">KAOSTUM.ID</span></a> -->
          <a href="<?php echo base_url();?>"><img width="150" style="margin-right:40px;" src="<?php echo base_url()?>/assets/logo_kaostum_panjang.svg"></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto navmain">
              <li class="nav-item">
                <a class="nav-link font-weight-bold" href="<?php echo base_url();?>produk/semua">PRODUCTS <span class="sr-only"></span></a>
              </li>
              ...
              <li class="nav-item">
                <a class="nav-link font-weight-bold" href="<?php echo base_url();?>produk/semua">GIFTS <span class="sr-only"></span></a>
              </li>
              <li class="nav-item dropdown">
                ...
                <div style:display:flex; class="searchings">
                  <input name="keyword" 
                    style="padding-left:5px;
                          ...
                          border-radius:2px;
                          padding-left:10px;
                          color:#fff;" class="searchers" type="text" id="search_input" placeholder="Cari Produk. . .">
                  ...
                  <button style="background:#000;border-left:0px;
                                border-top-left-radius:0px;
                                border-bottom-left-radius:0px;
                                border-top-right-radius:2px;
                                border-bottom-right-radius:2px;
