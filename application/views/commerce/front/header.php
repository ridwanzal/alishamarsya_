...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>assets/commerce/lightslider/css/lightslider.min.css" type="text/css">

    <link rel="stylesheet" href="<?php echo base_url();?>assets/commerce/css/style.css" type="text/css">
    <style>
    ...
    <!-- 
        https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/ajax-loader.gif
    -->
</head>
